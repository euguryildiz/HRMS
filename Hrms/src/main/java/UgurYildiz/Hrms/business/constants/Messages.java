package UgurYildiz.Hrms.business.constants;
...
public class Messages {
    ...
    public static String EMPLOYER_ERROR_EMAIL_IS_BLANK= "Employer's email number is blank";
    public static String EMPLOYER_ERROR_EMAIL_MAIL_EXTENSION = "Employer's mail extension must be the same as the web address";
    public static String EMPLOYER_ERROR_EMAIL_ALREADY_EXISTS = "Employer's email already exists";
}
